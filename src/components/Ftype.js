...
import { slide9, slide10, slide11, slide12,forward,arrow } from "../assets";
...
function Ftype() {
  ...
  return (
    <div className='max-w-[1400px] h-[780px] w-full m-auto py-16  relative group sm:px-0 px-0 sm:mt-[300px] mt-[-200px]'>
      ...
      <h1 className='text-white font-medium font-poppins ml-4 tracking-widest mt-[60px] text-[25px]'>JAGUAR F‑TYPE</h1>
