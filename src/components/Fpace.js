...
import { slide5, slide6, slide7, slide8,forward,arrow } from "../assets";
...
function Fpace() {
  ...
  return (
    <div className='max-w-[1400px] h-[780px] w-full m-auto py-16  relative group sm:px-0 px-0 sm:mt-[300px] mt-[-200px]'>
      <div
      ...
      <h1 className='text-white font-medium tracking-widest font-poppins ml-4  mt-[60px] text-[25px]'>JAGUAR F-PACE</h1>
      ...
      <div className='flex flex-row mt-[150px] ml-3 absolute hover:underline-offset-4'>
